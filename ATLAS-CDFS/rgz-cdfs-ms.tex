...
\section{Results}\label{sec:results}
  ...
  \subsection{Relation between binary classification and cross-identification}
    ...
    \begin{figure}
      ...
      estimate. The solid lines indicate the best linear fit. The high density
      of points at 50 per cent balanced accuracy, 0 per cent
      cross-identification accuracy for random forests is an artefact of our
      method of classifier generation, as random forests have much lower
      performance than logistic regression with less training data. We did not
      include convolutional neural networks in this test, as training them is
  ...
  \subsection{Application to ATLAS-CDFS}
    ...
    \caption{Balanced accuracies for each quadrant in the galaxy
      ...
      labels.      %, and `RGZ N' represents the Radio
    ...
    \autoref{tab:average-accuracies}. We also report the balanced accuracy of
    Radio Galaxy Zoo for comparison.
