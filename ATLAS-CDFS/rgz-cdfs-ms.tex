...
\begin{abstract}
  ...
  cross-identification. This has traditionally been done manually, which will be intractable for wide-area radio surveys
  ...
  with the nearest galaxy performs comparably to our more complex methods, though our estimated best-case performance is near 100 per cent.
  ATLAS contains 87 complex radio sources that have been cross-identified by experts,
  so there are not enough complex examples to learn how to cross-identify them accurately. Much larger
  ...
  comparable results to training on expert cross-identifications,
...
\section{Introduction}\label{introduction}
  ...
  source. A `compact' source is composed of a \edited{single unresolved component. \autoref{eq:compact} shows the definition of a resolved component. We
  assume that all unresolved components are compact sources, i.e. we assume that each unresolved component has its own host galaxy\footnote{\edited{This will be incorrect if the unresolved components are actually compact lobes or hotspots, but determining which components correspond to unique radio sources is outside the scope of this paper.}}.} An `extended'
...
\section{Data}\label{sec:data}
  ...
  \subsection{Cross-identification as binary classification}\label{sec:xid-as-binary-classification}
    ...
    highest-scored location coincides with the desired object (\eref{eq:score}). Square image
    ...
    \begin{algorithm}
        ...
        \For{$g \in \mathcal G$}{
          ...
          $score \leftarrow f(x) \times \frac{1}{\sqrt{2\pi\sigma^2}} \exp\left(-\frac{d^2}{2\sigma^2}\right);\quad \stepcounter{equation}\hfill(\theequation)\label{eq:score}$
          \BlankLine
          \If{$score > max$}{
            $max \leftarrow score$\;
            $host \leftarrow g$\;
  ...
  \subsection{Limitations of our approach}
    ...
    \begin{enumerate}
      ...
      \item The host galaxy of a radio component is within the 1~arcmin \edited{search radius around the component, measured from the centre of the Gaussian fit}.
...
\section{Results}\label{sec:results}
  ...
  \label{sec:cdfs-results}
    ...
    \begin{figure}
      ...
      \caption{Predicted host galaxies in the candidate classification task for ATLAS3~J032929.61-281938.9. \edited{The background image is an ATLAS radio image.} Radio Galaxy Zoo host galaxies
...
\section{Discussion}
  ...
  \edited{\aref{app:examples} (see \autoref{fig:examples}) shows examples of incorrectly cross-identified
...
\section{Acknowledgements}
  ...
  A.~Tran and the reviewer for their comments on this manuscript.
...
\section{SWIRE object scores}\label{app:scores}
  ...
  \begin{table}
    \caption{Scores output by our trained classifiers for SWIRE~CDFS candidate host galaxies. Columns are defined in \autoref{app:scores}. Full table electronic.}
...
J032603.75-284014.1 & 51.5156 & -28.6706 & no & no & 0.0547 & 0.3408 & 0.5388 & 0.4889 & 0.5242 & 0.7301 & 0.0542 & 0.2712 & 0.2318 & 0.5026 & 0.5631 & 0.5032 & 0.0595 & 0.0545 & 0.0000 & 0.4289 & 0.0789 & 0.1420 \\
  ...
  \begin{table}
    \caption{Scores output by our trained classifiers for SWIRE~ELAIS-S1 candidate host galaxies. Columns are defined in \autoref{app:scores}. Full table electronic.}
...
\section{ATLAS component cross-identifications}\label{app:xids}
  ...
  \begin{table*}
    \caption{Cross-identifications for ATLAS~CDFS components. Columns are defined in \autoref{app:xids}. Full table electronic.}
    \label{tab:cdfs-xids}
...
J032634.59-282022.8C & 51.6441 & -28.3397 & CI0757 & ARG0003rj2 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032631.96-281941.0 & 51.6332 & -28.3281 & 0.5781 & 0.5405 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 & J032634.58-282022.8 & 51.6441 & -28.3397 \\
  ...
  \begin{table*}
    \caption{Cross-identifications for ATLAS~ELAIS-S1 components. Columns are defined in \autoref{app:xids}. Full table electronic.}
...
\section{Cross-identification figures}\label{app:examples}
    ...
    \begin{figure*}
      \centering
      \subfloat[]{\includegraphics{images/examples_all/example_sorted_0_306.pdf}}
      % \subfloat[]{\includegraphics{images/examples_all/example_sorted_1_425.pdf}}

      \subfloat[]{\includegraphics{images/examples_all/example_sorted_2_0.pdf}}%
      \subfloat[]{\includegraphics{images/examples_all/example_sorted_3_454.pdf}}

      \subfloat[]{\includegraphics{images/examples_all/example_sorted_4_264.pdf}}%
      \subfloat[]{\includegraphics{images/examples_all/example_sorted_5_207.pdf}}
