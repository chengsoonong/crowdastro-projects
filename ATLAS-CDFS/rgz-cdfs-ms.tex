...
\section{Data}\label{data}
  ...
  \label{sec:limitations}
    ...
    a cross-identification accuracy of \todo{Get an up-to-date number} with our
    assumptions, which we take as an upper bound on our cross-identification
    accuracy. \todo{While getting the up-to-date number, might as well generate
    a table of accuracies for the appendix. The number can come from that.}
