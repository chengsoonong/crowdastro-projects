...
\section{Data}\label{data}
  ...
  classification}\label{cross-identification-as-binary-classification}
    ...
    \begin{figure}
      ...
      \caption{A $8'$-wide radio image from FIRST, centred on
        ...
        Zoo. This radio source breaks out assumption that the whole radio source
  ...
  \subsection{Classifiers}\label{sec:classifiers}
    ...
    \label{sec:convolutional-neural-networks}
      ...
      images. The model architecture we used is shown in Figure \ref{fig:cnn}. An
      example of this model reducing a radio image is shown in Figure
      \ref{fig:cnn-outputs}.
