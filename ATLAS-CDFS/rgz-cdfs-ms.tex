...
\section{Introduction}\label{introduction}
  ...
  to dominate approximately 30\% of sources detected by EMU \citep{norris11}. Small surveys of a few thousand sources such as the Australia
  Telescope Large Area Survey \citep[ATLAS;][]{norris06,middelberg08} can be cross-identified manually, but this is impractical for
  larger surveys.
  ...
  galaxies. This is the premise of Radio Galaxy Zoo \citep[RGZ;][]{banfield15,wong17}, a citizen science project hosted on the highly
...
\section{Data}\label{data}
  ...
  classification}\label{cross-identification-as-binary-classification}
    ...
    \begin{figure}
      ...
      \begin{tikzpicture}[node distance=2.4cm, auto]
        ...
        \node [decision, below of=init] (iscompact) {compact?};
        ...
        \node [block, right of=compact, fill=green!10] (done) {\textbf{host galaxy}};
  ...
  networks}\label{convolutional-neural-networks}
    ...
    are convolved with an input image to produce output images called *feature maps*, and these feature maps can then be convolved again with other filters on subsequent layers. This produces a network of convolutions. The whole network is
    ...
    features. For more detail, see \citeauthor[\S II.A]{lecun98}.
    ...
    in Figure \ref{convolutional-neural-networks}.

    {[}TODO: Add example of a CNN reducing a radio image.{]}
...
\section{Results}\label{results}
  ...
  \begin{figure}
  \centering
  \includegraphics[width=\columnwidth]{convolutions_42191.pdf}
