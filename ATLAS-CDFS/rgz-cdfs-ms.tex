    ...
    \label{sec:convolutional-neural-networks}
      ...
      \begin{figure}
        ...
        \caption{Architecture of our CNN. The merge layer flattens the output of
          the previous layer and adds the 10 features derived from the candidate
          host in SWIRE, i.e. the flux ratios, stellarity indices, and distance.
          The dropout layer drops $25\%$ of its inputs.}
        \label{fig:cnn}
      \end{figure}
