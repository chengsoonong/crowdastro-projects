...
\section{Results}\label{sec:results}
  ...
  \label{sec:relation}
    ...
    \begin{figure}
      ...
      $R^2 = 0.92$ for logistic regression and $R^2 = 0.86$ for random
    ...
    gives $R^2 = 0.92$ for logistic regression and $R^2 = 0.86$ for random
    forests.
  ...
  \subsection{Application to ATLAS~CDFS}
    ...
    \begin{figure}
      ...
      \caption{Balanced accuracies for different predictors on SWIRE objects
        ...
        performance of identifying the nearest-neighbour method, where the nearest SWIRE object to an ATLAS object is identified
    ...
    \begin{figure}
      ...
      \caption{Accuracies for each quadrant in the cross-identification
        ...
        we would expect to attain. The middle, dashed horizontal line shows the accuracy of nearest neighbours. The shaded areas surrounding the horizontal lines indicate the standard deviation across CDFS quadrants and classifiers.
...
\subsection{Application to ATLAS-ELAIS}
  ...
  \begin{figure}
    ...
    \caption{Accuracies for each quadrant in the cross-identification
      ...
      whole ELAIS-S1 field, and performance was measured against ground truth
      labels from~\citet{middelberg08}. The estimated best possible performance is nearly 100 per cent.
