...
\section{Results}\label{sec:results}
  ...
  \subsection{Application to ATLAS~CDFS}
    ...
    \caption{Performance of logistic regression (LR), convolutional neural networks (CNN), and random forest (RF) classifiers. `Norris' indicates classifiers trained on the expert labels and `RGZ' indicates classifiers trained on the Radio Galaxy Zoo labels. Performance on the galaxy classification task is quantified by balanced accuracy (top) and performance on the cross-identification task is quantified by accuracy (bottom). The training and testing sets have been split into compact and resolved objects, with results on compact objects shown on the left and results on resolved objects shown on the right. Shown for comparison is the accuracy of the Radio Galaxy Zoo consensus cross-identifications (Labels). The accuracy attained by a perfect classifier is shown by a solid green line, and the accuracy of a nearest-neighbours approach is shown by a dashed grey line. The standard deviation of these accuracies across the four CDFS quadrants is shown by the shaded area. Note that the pipeline shown in \autoref{fig:flowchart} is not used for these results.
        \label{fig:ba}}
    \end{figure}
    ...
    In \autoref{fig:ba} we plot the performance of logistic regression, random forests, and convolutional neural networks on both the galaxy classification task and the cross-identification task for resolved and compact sources.
    ...
    task, perform comparatively poorly when trained on Radio Galaxy Zoo labels. The high
    ...
    \begin{figure*}
        \subfloat[]{\includegraphics[trim={0cm 1cm 3.5cm 2.5cm}, clip, width=0.33\textwidth]{images/example_15_454.pdf}}%
        ...
        \subfloat[]{\includegraphics[trim={0cm 1cm 3.5cm 2.5cm}, clip, width=0.33\textwidth]{images/example_12_404.pdf}}%
        % \subfloat[]{\includegraphics[width=0.25\textwidth]{images/example_11_306.pdf}}%
        \subfloat[]{\includegraphics[trim={0cm 1cm 3.5cm 2.5cm}, clip, width=0.33\textwidth]{images/example_10_298.pdf}}
        ...
        \subfloat[]{\includegraphics[trim={0cm 1cm 3.5cm 2.5cm}, clip, width=0.33\textwidth]{images/example_4_106.pdf}}%
        % \subfloat[]{\includegraphics[width=0.25\textwidth]{images/example_3_86.pdf}}%
        \subfloat[]{\includegraphics[trim={0cm 1cm 3.5cm 2.5cm}, clip, width=0.33\textwidth]{images/example_2_68.pdf}}%
        % \subfloat[]{\includegraphics[width=0.25\textwidth]{images/example_1_30.pdf}}%
        \subfloat[]{\includegraphics[trim={0cm 1cm 3.5cm 2.5cm}, clip, width=0.33\textwidth]{images/example_0_0.pdf}}%
        \caption{\label{fig:examples} \todo{write}}
    \end{figure*}
...
\subsection{Application to ATLAS-ELAIS}
  ...
  \caption{\todo{write; fix references}
    \label{fig:elais-ba}}
  \end{figure}
  ...
  This is likely because there is a much higher percentage of compact objects in ELAIS-S1 than in CDFS. The maximum achievable accuracy we have estimated for ELAIS-S1 is very close to 100 per cent, so a very accurate binary classifier could outperform nearest neighbours.

  One interesting difference between the ATLAS fields is that random forests trained on expert
